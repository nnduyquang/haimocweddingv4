...
<div id="h_12" class="pl-lg-5 pr-lg-5 pl-3 pr-3">
    ...
    <div class="row pl-lg-5 pr-lg-5 pl-3 pr-3">
        <div class="col-md-4 mb-3">
            <a href="{{URL::to('album')}}">
                <div class="sv_banner" style="background-image:url({{URL::asset('images/uploads/images/album/hahoai131018/HAI_0153%20copy.jpg')}});">
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="sv_banner" style="background-image:url({{URL::asset('images/uploads/images/family/giadinh/17.jpg')}});">
                <div class="border-top-bot"></div>
                <div class="sv_content">
